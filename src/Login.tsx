...
export function Login() {
  ...
  useEffect(() => {
    if (isAuthenticated) navigate("/main/ordenes")
    console.log(isAuthenticated)
  }, [isAuthenticated])
  return (
    <>
      <div className="w-[100vw] overflow-hidden h-[100vh] relative">
        <div className="backback absolute lg:block lg:w-[100vw] lg:h-[100vh] left-0">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
        </div>  
        <div className="absolute w-[500px] h-[100vh] sm:h-[100vh] left-0 bg-white opacity-[.9]">
          <div className="flex lg:w-[500px] sm:w-[100vw] sm:h-[100vh] min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 sm:mt-0 lg:m-0 z-10">
