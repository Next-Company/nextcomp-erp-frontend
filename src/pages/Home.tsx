  ...
  return (
    <>
      <div className="directory flex flex-col p-4 m-3 rounded-md bg-white w-full relative">
        ...
        <button className="border border-red-500 w-10 h-10" onClick={()=>setEstado(!estado)}>Click Me!</button>
        ...
        <div className="w-[100px]">
          <ButtonLoader type="button" tipo="default" loading={estado}>Congelar</ButtonLoader>
        </div>
