  ...
  const onclick = (e) => {
    ...
    switch (action) {
      case 'delete':
        params_modal = {
          open: true,
          content: <div>Desea eliminar el registro seleccionado?. Tenga en cuenta de que el <br /> proceso no es reversiblessss.</div>,
          controls: true,
          header: false,
          action: () => {
            setOpenloader(true)
            Consulta({
              ...
              url: 'almacen/deletedespacho/' + id, params: {
                method: 'DELETE'
              }
            })
              .then(resp => {
      ...
      case 'download':
        params_modal = {
          open: true,
          content: <div>Desea continuar con la descarga de la guia de traslado?.<br />  Tenga en cuenta de que el proceso puede tardar unos minutos.</div>,
          controls: true,
          header: false,
          action: () => {
            const desc = async () => {
              ...
              Consulta({
                ...
                url: motivo == 'prd' ? 'almacen/vistapreviadespachocorte/TELAS' : 'almacen/vistapreviadespacho/TELAS', params: {
                  method: 'POST',
                  body: data
                }
              })
      ...
      case 'review':
        ...
        break;
      case 'cuadre':
        navigate("/main/almacen/movimientos/cuadre/" + id)
        break;
                        ...
                        <tr key={key} className="">
                          ...
                          <td className="w-[250px]">
                            <ul className="flex flex-row justify-end">
                              ...
                              <li>
                                <div className="rounded-full w-9 h-9 hover:bg-gray-100 transition-colors flex justify-center items-center" data-action="download" onClick={onclick} data-id={row.id_CAB} data-motivo={row.motivo}>
                              ...
                              {/* <li>
                                <div className="rounded-full w-9 h-9 hover:bg-gray-100 transition-colors flex justify-center items-center" data-action="cuadre" onClick={onclick} data-id={row.id_CAB}>
