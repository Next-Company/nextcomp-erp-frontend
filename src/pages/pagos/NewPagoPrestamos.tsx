...
export default function NewPagoPrestamo(){
  ...
  useEffect(()=>{
    if(urlparams.id && urlparams.tipo){
      setOpenloader(true)
      Consulta({ url: 'abonos/prestamostatusdetalle/' + urlparams.id })
      .then(resp => {
        ...
        <div className="pl-2 pr-2 pt-2 flex flex-col flex-1 h-full">
          <div className="flex flex-col gap-2">
            <div className="flex justify-start items-center">
              <h2 className="font-medium text-[16px] pr-2">Abonos a prestamos /</h2>
