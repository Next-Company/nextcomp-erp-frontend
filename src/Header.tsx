            ...
            <ul className='[&_li:hover]:bg-gray-100 [&_li]:flex [&_li]:items-center'>
              <li>
                <div className='flex gap-2 p-3'>
                  ...
                  <div onClick={logout} className='flex flex-col items-center text-left'>Configuración</div>
                </div>
              </li>
            </ul>
            <hr />
            <ul className='[&_li:hover]:bg-gray-100 [&_li]:flex [&_li]:items-center'>
              <li>
                <div className='flex gap-2 p-3'>
                  ...
                  <div onClick={logout} className='flex flex-col items-center text-left'>Cerrar sesión</div>
                </div>
              </li>
            </ul>
          </div>
