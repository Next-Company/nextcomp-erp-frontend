  ...
  return(
    <>
      ...
      <div className="flex h-[100%]">
        <div className="flex flex-col flex-none p-5 gap-y-4 w-[20%] bg-[rgb(79,70,229)]">
          <div>
            <img src="/elenex.svg" alt="" className="h-10 w-auto"/>
          </div>
          <div>
            <ul>
              <li className="p-2">
                <a href="/" className="flex h-[30px]">
        ...
        <div className="flex-1 w-64 bg-[white]">
          <div></div>
          <div></div>
        </div>
      </div>
