...
export function Dasboard(){
  return(
    <>
      <div className="flex flex-col h-[100vh] text-[14px]">
        <div className="flex items-center h-[50px] bg-white border-b">
          <div className="">
        ...
        <div className="flex flex-1 bg-[rgba(255,90,0,.12)]">
          {/* <nav className="flex flex-col text-[12px] [&_div]:p-3 flex-none gap-y-3 w-[15%] bg-[white]">
          ...
          {/* <nav className="flex h-[100%] flex-none w-[15%] bg-[white] overflow-y-auto"> */}
          <div className="w-[15%] h-[100%] bg-[white] overflow-y-auto">
            <div className="m-3 w-[100px] h-[950px] bg-black"></div>
          </div>
          <div className="bg-gray flex-1">sdfds</div>
        </div>
      </div>
    </>
  )
