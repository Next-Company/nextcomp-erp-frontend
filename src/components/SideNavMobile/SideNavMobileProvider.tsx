    ...
    <SideNavMobile.Provider value={{openMenu,closeMenu}}>
      <div ref={sidenav} className='w-[300px] rounded-r-xl translate-x-[-300px] transition-transform bg-gray-200 absolute left-0 top-0 flex-column flex-1 z-50 h-full'>
        ...
        <div className='flex-1 bg-green-500'>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Opcion1</div>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio' onClick={()=>alert("Hola urano")}>Opcion1</div>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Opcion1</div>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Opcion1</div>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Opcion1</div>
          <div className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Opcion1</div>
          <div onClick={redirect} className='nav_option bg-gray-100 h-[50px] flex justify-start pl-4 hover:bg-orange-400 items-center cursor-pointer' data-fd='directorio'>Directorio</div>
        </div>
