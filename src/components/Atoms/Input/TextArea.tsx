  ...
  return (
    <>
      <div onClick={onclick} className="rounded-md bg-gray-100 flex flex-col justify-start items-start pl-[16px] pr-[16px] pt-[5px] pb-[10px] hover:bg-gray-200 relative group overflow-hidden">
        ...
        <textarea onClick={(e) => e.stopPropagation()} name={name} defaultValue={initial} onFocus={onfocus} onBlur={onblur} rows={4} className="w-full bg-inherit focus:border-none focus-within:border-none focus-visible:border-none focus:outline-none resize-none"></textarea>
