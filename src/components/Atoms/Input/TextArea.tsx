  ...
  return (
    <>
      ...
      <div onClick={onclick} className="rounded-md bg-gray-100 flex flex-col justify-start items-start pl-[16px] pr-[16px] pt-[5px] pb-[10px] hover:bg-gray-200 relative group overflow-hidden">
        ...
        <textarea name="" id="" onFocus={alter_label} onBlur={alter_label2} rows={15} className="w-full bg-inherit focus:border-none focus-within:border-none focus-visible:border-none focus:outline-none resize-none"></textarea>
