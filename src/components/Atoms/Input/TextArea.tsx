...
export function TextArea({ title, name, valor = "", rows = 4 }) {
  ...
  return (
    <>
      ...
      {/* value={initial} */}
        ...
        <textarea onClick={(e) => e.stopPropagation()} onChange={onkeyup} name={name} value={initial} onFocus={onfocus} onBlur={onblur} rows={rows} className="w-full bg-inherit focus:border-none focus-within:border-none focus-visible:border-none focus:outline-none resize-none"></textarea>
