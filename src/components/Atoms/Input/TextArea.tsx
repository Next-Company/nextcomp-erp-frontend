  ...
  return (
    <>
      ...
      {/* value={initial} */}
        ...
        <textarea onClick={(e) => e.stopPropagation()} onChange={onkeyup} name={name} value={initial}  onFocus={onfocus} onBlur={onblur} rows={15} className="w-full bg-inherit focus:border-none focus-within:border-none focus-visible:border-none focus:outline-none resize-none"></textarea>
